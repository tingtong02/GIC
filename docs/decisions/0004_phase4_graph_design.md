...
- Dataset-specific sample export roots are required once Phase 4 starts producing sparsity and feature ablation variants, otherwise graph-ready samples would overwrite each other.
...
- Phase 4 comparison results can now be reproduced across multiple exported dataset variants without reintroducing training-time graph construction.
